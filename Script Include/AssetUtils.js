          ...
          if (assetGr.next()) {
            ...
            if (modelCategory) {
              ...
              modelCatGr.addEncodedQuery(
                "nameINApple Device,Computer,Computer Cart,Credit Card Machine,IP Phone,Laptop,Printer,Scanner,Tablet,^asset_class!=NULL"
              );
              modelCatGr.query();
              if (modelCatGr.next()) {
            ...
            if (congItem) {
              var cmdbGr = new GlideRecord("cmdb_ci");
                ...
                if (cmdbGr.next()) {
                    ...
                    ritmComments +=
                      "Row " +  rowNum +
                        ": Configuration Item '" + congItem + "' not found.<br/>";
                }
            }   else {
                assetGr.ci = "";
            }   
            ...
            if (location) {
                ...
                if (locGr.next()) {
                    ...
                    ritmComments +=
                      "Row " +  rowNum +
                        ": Location '" + location + "' not found.<br/>";
                }
            } else {
                assetGr.location = "";
            }
            ...
            if (modelCategory) {
                ...
                if (modelCatGr.next()) {
                    ...
                    ritmComments +=
                      "Row " +  rowNum +
                        ": Model Category '" + modelCategory + "' not found.<br/>";
                }
            }
            if (assignedTo) {
                var userGr = new GlideRecord("sys_user");
                ...
                if (userGr.next()) {
                    ...
                    ritmComments +=
                      "Row " +  rowNum +
                        ": Assigned to user with email '" + assignedTo + "' not found.<br/>";
                }
            } else {
                assetGr.assigned_to = "";
            }
            ...
            var assetGrUpdate = new GlideRecord("alm_asset");
